// Upstream: MarchingCubeCpp (MC.h). Vendored VERBATIM from the single-header library
// (https://github.com/aparis69/MarchingCubeCpp), the third-party dependency
// MuJoCo fetches for mjCMesh::LoadSDF (src/user/user_mesh.cc:50 #include <MC.h>).
// Provenance + registry: snapshots/lifted_code.json (symbol MC::marching_cube).
// The implementation body is guarded by MC_IMPLEM_ENABLE and instantiated once
// in marching_cube.cc; other TUs include this for the declarations only.
// Do not edit: the drift gate diffs this against the upstream single header.
