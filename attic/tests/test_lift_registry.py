...
# Repo root: this suite lives at attic/tests/, and registry paths are repo-root
# relative (attic/tests/test_lift_registry.py -> parents[2] == repo root).
ROOT = Path(__file__).resolve().parents[2]
_SPEC = importlib.util.spec_from_file_location(
    "lift_registry", ROOT / "attic" / "tools" / "lift_registry.py"
)
