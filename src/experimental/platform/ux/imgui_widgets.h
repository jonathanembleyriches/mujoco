...
static constexpr const char ICON_FA_MOUSE_POINTER[] = "\xEF\x89\x85";  // U+F245
static constexpr const char ICON_FA_ARROWS_ALT[] = "\xEF\x82\xB2";     // U+F0B2
static constexpr const char ICON_FA_PAUSE[] = "\xEF\x81\x8C";
static constexpr const char ICON_FA_PLAY[] = "\xEF\x81\x8B";
static constexpr const char ICON_FA_STOP[] = "\xEF\x81\x8D";           // U+F04D
